...
import re
from xml.sax.saxutils import escape, unescape # XXX kwood
...
class Encoder:
    ...
    def needsEncoding(self, s):
        ...
        #        return True
        #return False
        return True # XXX kwood: This is a useless function, not going to save us any time
    ...
    def encode(self, s):
        ...
        #        s = re.sub(x[0], x[1], s)
        if isinstance(s, basestring): # XXX kwood
            s = escape(s)
        return s
